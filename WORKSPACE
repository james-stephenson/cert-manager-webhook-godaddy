...
go_repository(
    ...
    sum = "h1:Bcm1LdNk5NZ10WvOhh464FOgHKBjNMpOxNJTS+VFiuk=",
    version = "v0.15.1",
)
...
go_repository(
    ...
    sum = "h1:h6oZO+iAgg0HjxmuNnguNdKNB9+wv3O1EBDdDWJViQ0=",
    version = "v0.18.3",
)
...
go_repository(
    ...
    sum = "h1:BVjccwKP/kEqY+ResOyWs0EKs7f4XL0d0E5GkU3uiqI=",
    version = "v0.18.3",
)
...
http_archive(
    name = "io_kubernetes",
    sha256 = "a7d0ca45800b3107a56c7a9a4070d0372f69dfa07713f4d040b6a76ef1164d74",
    strip_prefix = "kubernetes-1.18.6",
    urls = ["https://github.com/kubernetes/kubernetes/archive/v1.18.6.zip"],
)
...
load("@com_github_jetstack_cert_manager//hack/bin:deps.bzl", _jetstack_install = "install")
